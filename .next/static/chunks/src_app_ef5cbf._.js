...
function Home() {
    ...
    const [budget] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(237500000000);
    ...
    const totalSpent = Object.entries(purchases).reduce((sum, [key, quantity])=>{
        const product = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$data$2f$product$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["initialProducts"].find((p)=>p.id === parseInt(key));
...
_s(Home, "vp7T9MlHOSqUJnz5q9aa9jF4wig=");
_c = Home;
var _c;
