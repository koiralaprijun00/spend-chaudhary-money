    ...
    <>
      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        ...
        <section className="prose prose-lg max-w-none text-left">
          ...
          <h2 id="interactive-nepal-map">Geography Without The Boring Textbooks</h2>
          <p>
            In <Link href="/patta-lagau" aria-label="Play Patta Lagau geography game">Patta Lagau</Link>, test your knowledge of Nepal's geography in a fun and interactive way. See if you can identify the most famous landmarks faster than your driver can find his way there!
          </p>
